...
#
# .py mirror of `finetune_qwen3_0p6b.ipynb`. Same logic, no notebook
...
# rerun individually).
#
# 0.6B sibling of `finetune_qwen3_1p7b.ipynb` (the production 1.7B path).
# Use this when you want to A/B reliability + on-device latency against
# the smaller model.
#
# Mirrors the patched `../colab/finetune_qwen3_1p7b.py` trainer setup
# (2026-05-09 trainer fixes baked
...
# MODEL_NAME = "unsloth/Qwen3-1.7B-bnb-4bit"          # production 1.7B - use finetune_qwen3_1p7b.ipynb instead
